  ...
  htmlData = [
    {
      ...
      'infoDataOne': `${currentUser.dataSets.hydration.getTotalAverage()} oz`,
      'labelOne': 'water consumed',
      'timeOne': 'ALL TIME DAILY AVERAGE',
      'infoDataTwo': `${currentUser.dataSets.hydration.getWeeklyTotal(date)} oz`,
      'labelTwo': 'water consumed',
      'timeTwo': 'LAST 7 DAYS',
      'infoDataThree': `${currentUser.dataSets.hydration.getDailyHydration(date)} oz`,
